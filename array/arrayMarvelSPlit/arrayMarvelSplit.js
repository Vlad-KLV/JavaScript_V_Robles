...
var marvelNew=[];
var nuevo_array = marvelOrdenCronologico.map(function callback(i, index, array) {
    ...
    modificado.push(" Message for MentorV :this exercises is done without copying")
    //modificado.push("casi sin copiar");
    


    marvelNew.push(modificado);

});
console.log("marvel  :" + JSON.stringify(marvelNew, null, '\t'));
